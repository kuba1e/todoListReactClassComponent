...
export const toggleDoneTodo = (id)=>({type:ACTION_TOGGLE_DONE_TO_DO, payload:id})

export const ACTION_TOGGLE_DONE_ALL_TO_DO='ACTION_TOGGLE_DONE_ALL_TO_DO'
export const toggleAllDoneTodo=(status)=>({type:ACTION_TOGGLE_DONE_ALL_TO_DO, payload:status})
...
export const setFilterValue = (value)=>({type:ACTION_SET_FILTER_VALUE, payload:value})

export const ACTION_GET_TODOS_FROM_LOCAL_STORAGE='ACTION_GET_TODOS_FROM_LOCAL_STORAGE'
export const getTodosFromLocalStorage = (todos)=>({type:ACTION_GET_TODOS_FROM_LOCAL_STORAGE, payload:todos})